...
namespace Terrain3DTools.Layers
{
    ...
    public abstract partial class FeatureLayer : TerrainLayerBase
    {
        ...
        /// <summary>
        /// Identifies if this feature layer is an instancer.
        /// Instancers process after all other features and don't modify terrain data.
        /// </summary>
        public virtual bool IsInstancer => false;
        ...
        /// <summary>
        /// Creates GPU commands to write this feature's exclusion influence.
        /// Override in layers that should block instance placement (paths, structures).
        /// Default implementation returns null (no exclusion written).
        /// </summary>
        public virtual (Action<long> commands, List<Rid> tempRids, List<string> shaders) CreateWriteExclusionCommands(
            Vector2I regionCoords,
            RegionData regionData,
            int regionSize,
            Vector2 regionMinWorld,
