...
namespace Terrain3DTools.Core.Debug
{
    ...
    public partial class DebugManager : GodotObject
    {
        ...
        /// Safely handles mixed resource types in the array.
        /// </summary>
        /// <param name="configArray">The array of debug configurations</param>
        /// <param name="silent">If true, suppresses verbose logging output</param>
        public void UpdateFromConfigArray(Array<ClassDebugConfig> configArray, bool silent = false)
        {
            _classConfigs.Clear();
            ...
            if (!silent && _classConfigs.Count > 0)
            {
