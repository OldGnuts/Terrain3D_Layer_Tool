// /Core/TerrainHeightQuery.cs
using Godot;
using Terrain3DTools.Debug;
using System;
...
namespace Terrain3DTools.Core
{
    public static class TerrainHeightQuery
    {
        ...
        public static float? QueryHeight(Vector2 worldPosition, TerrainLayerManager terrainManager)
        {
            ...
            float worldHeightScale = terrainManager.WorldHeightScale;
            ...
            var heightImage = DebugHelper.TextureToImage(regionData.HeightMap, regionSize, regionSize, Image.Format.Rf);
            if (heightImage == null)
                return null;
